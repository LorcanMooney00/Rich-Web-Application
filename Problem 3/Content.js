...
const videotitle = document.getElementsByTagName("h3"); 
let j=0
for(let i = 0; i < imgs.length; i++) {
    const randomImg = Math.floor(Math.random() * catsImages.length)
    check = catsImages[randomImg]
    imgs[i].src=check
    if (check==="https://lh3.googleusercontent.com/pw/AL9nZEXYJlrVkYoKIkpx07_3F4HOiTiOheaoaiRAcwrUg3C613-jkzEubJ3k8Z9fDjG5IfVqCzorphZ00vp6mIyB79GtCsoyV69xXe9cqrA0zglgrcvYhH2UP4cDR88WTm1AmuyCxQHAWCB5JzKD7eD94dtNZA=w690-h920-no"){
        videotitle[j].innerText = "dogs are cool."; 
        j++;
    }
    else{
        videotitle[j].innerText = "cats are cool.";
        j++;
    }
